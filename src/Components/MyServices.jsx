...
function MyServices({history,progress,setProgress,currentUser}){
const [focus,setFocus] = useState('');
  ...
  <Link onClick={()=>{handleLocation()}} color="inherit" className={classes.link} style={{color:focus==='Location'?'Black':'Gray'}}>
    Location
  </Link>
  <Link  onClick={handleWorkingHours} color="inherit" className={classes.link} style={{color:focus==='WorkingHours'?'':'Gray'}}>
    Working Hours
  </Link>
